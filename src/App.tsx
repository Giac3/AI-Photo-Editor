...
function App() { 
  ...
  function convertFile(files: FileList|null) {
    ...
    document.getElementById('choose-photo2')!.style.display = "none"
...
const handleResult = async (result:any) => {
  ...
  <div id='main' className='grid place-items-center '>
    ...
    <div className=' bg-slate-500 h-72 mt-24 w-72 rounded-md text-center content-center'>
      ...
      <p id='choose-photo2' className='text-white mt-1 font-serif font-medium text-sm'>*Image Must Fill Square</p>
      <button id='photo-button' className='bg-blue-500 duration-1000 shadow-md hover:bg-slate-200 fill-white hover:fill-black w-32 h-12 ml-20 mt-16 rounded-md flex justify-center items-center'>
